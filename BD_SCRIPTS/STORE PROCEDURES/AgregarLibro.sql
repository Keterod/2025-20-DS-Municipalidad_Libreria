...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO Libros (titulo, autor, genero, año_publicacion, estado_L, descripcion, imagen_url)
        VALUES (@titulo, @autor, @genero, @año_publicacion, @estado_L, @descripcion, @imagen_url);
